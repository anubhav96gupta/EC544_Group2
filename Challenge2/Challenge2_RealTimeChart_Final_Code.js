...
var layout = {title : 'Average Temperature', xaxis : { title : 'Time'}, yaxis : { title : 'Temperature (Degree Celsius)'}};
var initlayout = {layout : layout, fileopt : 'overwrite', filename : 'nodenodenode'};
